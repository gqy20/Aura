...
- 已验证：`./gradlew.bat testDebugUnitTest` 通过（**634 个测试，0 失败**；最近核对 2026-08-09，含聊天恢复交互、MCP 渐进路由、Android 工具参数兼容、Dream Loop、InsightValidator、EvidenceResolver、ReactiveCompanion、FTS5、Health 双源与 ChatViewModel POST_CHAT 触发等用例）。
